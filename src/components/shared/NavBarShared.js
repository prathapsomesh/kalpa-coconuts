    ...
    return (
                    ...
                    <Row>
                        ...
                        <Col md={6} >
                            <div className="d-flex justify-content-xl-end align-items-center">
                                <Button variant="outline-dark" onClick={openContactModalNow}  className="m-2 openSansSemiBold btnIcons">
            ...
            <Navbar collapseOnSelect bg="white" expand="md" variant="light">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    ...
                    <Nav.Link className="black hoverred openSansSemiBold" ><NavLink className="black hoverred" to={'/contactus'}>CONTACT US</NavLink></Nav.Link>
                </Navbar.Collapse>
            </Navbar>
            ...
            {openContactModal ? <ContactNowModal show={openContactModal} handleClose={openContactModalNow} />:null}
            </div>
        </>
    )
}
